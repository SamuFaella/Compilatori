...
#line 143 "parser.cpp"
    ...
    : super_type (YY_MOVE (that.state), YY_MOVE (that.location))
  {
    switch (that.kind ())
    {
      case symbol_kind::S_body: // body
        value.YY_MOVE_OR_COPY< BodyExprAST* > (YY_MOVE (that.value));
        break;
    ...
    : super_type (s, YY_MOVE (that.location))
  {
    ...
    {
      case symbol_kind::S_body: // body
        value.move< BodyExprAST* > (YY_MOVE (that.value));
        break;
  ...
  parser::stack_symbol_type::operator= (const stack_symbol_type& that)
  {
    ...
    {
      case symbol_kind::S_body: // body
        value.copy< BodyExprAST* > (that.value);
        break;
  ...
  parser::stack_symbol_type::operator= (stack_symbol_type& that)
  {
    ...
    {
      case symbol_kind::S_body: // body
        value.move< BodyExprAST* > (that.value);
        break;
  ...
  yyreduce:
    ...
    {
      case symbol_kind::S_body: // body
        yylhs.value.emplace< BodyExprAST* > ();
        break;
...
#line 936 "parser.cpp"
  ...
  case 7: // def: globalvar
#line 113 "parser.yy"
                        { yylhs.value.as < DefAST* > () = yystack_[0].value.as < GlobalVariableAST* > (); }
#line 942 "parser.cpp"
    break;

  case 8: // globalvar: "global" "id" "=" cExpr
#line 116 "parser.yy"
                          { yylhs.value.as < GlobalVariableAST* > () = new GlobalVariableAST(yystack_[2].value.as < std::string > (),yystack_[0].value.as < ExprAST* > ()); }
#line 948 "parser.cpp"
    break;

  case 9: // globalvar: "global" "id"
#line 117 "parser.yy"
                          { yylhs.value.as < GlobalVariableAST* > () = new GlobalVariableAST(yystack_[0].value.as < std::string > ()); }
#line 954 "parser.cpp"
    break;

  case 10: // cExpr: "number"
#line 120 "parser.yy"
                          { yylhs.value.as < ExprAST* > () = new NumberExprAST(yystack_[0].value.as < int > ()); }
#line 960 "parser.cpp"
    break;

  case 11: // cExpr: cExpr "+" cExpr
#line 121 "parser.yy"
                          { yylhs.value.as < ExprAST* > () = new BinaryExprAST("+",yystack_[2].value.as < ExprAST* > (),yystack_[0].value.as < ExprAST* > ()); }
#line 966 "parser.cpp"
    break;

  case 12: // cExpr: cExpr "-" cExpr
#line 122 "parser.yy"
                          { yylhs.value.as < ExprAST* > () = new BinaryExprAST("-",yystack_[2].value.as < ExprAST* > (),yystack_[0].value.as < ExprAST* > ()); }
#line 972 "parser.cpp"
    break;

  case 13: // cExpr: cExpr "*" cExpr
#line 123 "parser.yy"
                          { yylhs.value.as < ExprAST* > () = new BinaryExprAST("*",yystack_[2].value.as < ExprAST* > (),yystack_[0].value.as < ExprAST* > ()); }
#line 978 "parser.cpp"
    break;

  case 14: // cExpr: cExpr "/" cExpr
#line 124 "parser.yy"
                          { yylhs.value.as < ExprAST* > () = new BinaryExprAST("/",yystack_[2].value.as < ExprAST* > (),yystack_[0].value.as < ExprAST* > ()); }
#line 984 "parser.cpp"
    break;

  case 15: // cExpr: cExpr "%" cExpr
#line 125 "parser.yy"
                          { yylhs.value.as < ExprAST* > () = new BinaryExprAST("%",yystack_[2].value.as < ExprAST* > (),yystack_[0].value.as < ExprAST* > ()); }
#line 990 "parser.cpp"
    break;
...
#line 996 "parser.cpp"
  ...
  case 17: // extdef: "external" prototype
#line 129 "parser.yy"
                        { yystack_[0].value.as < PrototypeAST* > ()->setext(); yylhs.value.as < PrototypeAST* > () = yystack_[0].value.as < PrototypeAST* > (); }
#line 1002 "parser.cpp"
    break;

  case 18: // funcdef: "function" prototype body "end"
#line 132 "parser.yy"
                                   { yylhs.value.as < FunctionAST* > () = new FunctionAST(yystack_[2].value.as < PrototypeAST* > (),yystack_[1].value.as < BodyExprAST* > ()); }
#line 1008 "parser.cpp"
    break;

  case 19: // body: assignments "return" expr
#line 135 "parser.yy"
                                 { yylhs.value.as < BodyExprAST* > () = new BodyExprAST(yystack_[2].value.as < std::vector<std::pair<std::string, ExprAST*>> > (), yystack_[0].value.as < ExprAST* > ()); }
#line 1014 "parser.cpp"
    break;

  case 20: // body: expr
#line 136 "parser.yy"
                                  { yylhs.value.as < BodyExprAST* > () = new BodyExprAST({}, yystack_[0].value.as < ExprAST* > ()); }
#line 1020 "parser.cpp"
    break;

  case 21: // assignments: %empty
#line 140 "parser.yy"
                        { std::vector<std::pair<std::string, ExprAST*>> B; yylhs.value.as < std::vector<std::pair<std::string, ExprAST*>> > () = B; }
#line 1026 "parser.cpp"
    break;

  case 22: // assignments: bindings
#line 141 "parser.yy"
                        { yylhs.value.as < std::vector<std::pair<std::string, ExprAST*>> > () = yystack_[0].value.as < std::vector<std::pair<std::string, ExprAST*>> > (); }
#line 1032 "parser.cpp"
    break;

  case 23: // prototype: "id" "(" params ")"
#line 144 "parser.yy"
...
#line 1218 "parser.cpp"
  ...
  case 54: // relexpr: expr "<" expr
#line 203 "parser.yy"
                          { yylhs.value.as < ExprAST* > () = new BinaryExprAST("<",yystack_[2].value.as < ExprAST* > (),yystack_[0].value.as < ExprAST* > ()); }
#line 1224 "parser.cpp"
    break;

  case 55: // relexpr: expr "==" expr
#line 204 "parser.yy"
                          { yylhs.value.as < ExprAST* > () = new BinaryExprAST("==",yystack_[2].value.as < ExprAST* > (),yystack_[0].value.as < ExprAST* > ()); }
#line 1230 "parser.cpp"
    break;

  case 56: // relexpr: expr "<>" expr
#line 205 "parser.yy"
                          { yylhs.value.as < ExprAST* > () = new BinaryExprAST("<>",yystack_[2].value.as < ExprAST* > (),yystack_[0].value.as < ExprAST* > ()); }
#line 1236 "parser.cpp"
    break;

  case 57: // relexpr: expr "<=" expr
#line 206 "parser.yy"
                          { yylhs.value.as < ExprAST* > () = new BinaryExprAST("<=",yystack_[2].value.as < ExprAST* > (),yystack_[0].value.as < ExprAST* > ()); }
#line 1242 "parser.cpp"
    break;

  case 58: // relexpr: expr ">" expr
#line 207 "parser.yy"
                          { yylhs.value.as < ExprAST* > () = new BinaryExprAST(">",yystack_[2].value.as < ExprAST* > (),yystack_[0].value.as < ExprAST* > ()); }
#line 1248 "parser.cpp"
    break;

  case 59: // relexpr: expr ">=" expr
#line 208 "parser.yy"
                          { yylhs.value.as < ExprAST* > () = new BinaryExprAST(">=",yystack_[2].value.as < ExprAST* > (),yystack_[0].value.as < ExprAST* > ()); }
#line 1254 "parser.cpp"
    break;

  case 60: // letexpr: "let" bindings "in" expr "end"
#line 211 "parser.yy"
...
#line 1266 "parser.cpp"
  ...
  case 62: // bindings: binding "," bindings
#line 215 "parser.yy"
...
#undef YYCASE_
  ...
  parser::yypact_[] =
  {
      -9,   -32,   -32,   -25,    12,   -43,    -9,   -43,   -43,   -43,
       6,   -43,    56,    10,   -43,   -43,   -13,    58,    58,    -3,
      11,     9,   -43,    15,    21,   125,   -43,   -43,   -43,    60,
      -2,   -13,    49,    57,   -43,    70,    -3,   -43,   -43,    -3,
     105,    44,    80,     8,   -43,   -43,    66,    59,    58,    58,
     -43,    58,    58,    58,    58,    58,    58,    11,    -2,   -43,
     130,   -43,   -43,   -43,    91,     1,   -43,    58,    58,    58,
      58,    58,    58,   -43,    -3,    58,    -3,    -3,    58,   120,
      76,   -43,   125,   125,   108,   108,   -43,   -43,   -43,   -43,
     -43,    -2,    -2,    -2,    -2,    -2,   -43,   125,   125,   125,
     125,   125,   125,   -43,   125,   -43,    68,    64,    58,   -43,
     133,   133,   -43,   -43,   -43,   -43,   -43
  };
  ...
  {
       0,     0,     0,     0,     0,     2,     4,     7,     5,     6,
       0,    17,    21,     9,     1,     3,    24,     0,     0,     0,
       0,    33,    35,     0,     0,    20,    36,    37,    22,    61,
       0,    24,     0,    33,    31,     0,     0,    52,    53,     0,
       0,     0,    43,     0,    50,    51,     0,     0,    38,     0,
      18,     0,     0,     0,     0,     0,     0,     0,     0,    10,
       8,    25,    23,    32,     0,     0,    48,     0,     0,     0,
       0,     0,     0,    42,     0,     0,     0,     0,     0,    40,
       0,    39,    63,    19,    27,    26,    28,    29,    30,    62,
      16,     0,     0,     0,     0,     0,    49,    57,    54,    55,
      56,    59,    58,    44,    45,    46,    47,     0,     0,    34,
      12,    11,    13,    14,    15,    60,    41
  };

  const signed char
  parser::yypgoto_[] =
  {
     -43,   -43,    96,   -43,   -43,   -42,   -43,   -43,   -43,   -43,
     102,   113,   -12,   -43,    37,   -43,    72,   -43,   -29,   -43,
     -43,   -43,   -19,   -43
  };
  ...
  parser::yydefgoto_[] =
  {
       0,     4,     5,     6,     7,    60,     8,     9,    23,    24,
      11,    32,    40,    80,    81,    26,    41,    42,    43,    44,
      45,    27,    28,    29
  };
  ...
  parser::yytable_[] =
  {
      25,    47,    10,    17,    58,    34,    35,    65,    36,    13,
      66,    75,    14,    96,     1,     2,    90,    16,    37,    38,
      48,    31,    19,     3,    64,    39,    20,    76,    77,    49,
      30,    33,    22,    59,    76,    77,    79,    82,    89,    83,
      84,    85,    86,    87,    88,    46,    50,   105,   106,   110,
     111,   112,   113,   114,    51,    97,    98,    99,   100,   101,
     102,    62,    17,   104,    17,    57,   107,    18,    48,    18,
      52,    53,    54,    55,    56,    73,    52,    53,    54,    55,
      56,    19,    63,    19,    74,    20,    49,    20,   109,    78,
      21,    22,    33,    22,    76,   115,    79,    52,    53,    54,
      55,    56,    15,    63,    12,    67,    68,    69,    70,    71,
      72,    52,    53,    54,    55,    56,    54,    55,    56,    67,
      68,    69,    70,    71,    72,   108,    52,    53,    54,    55,
      56,    52,    53,    54,    55,    56,    91,    92,    93,    94,
      95,    93,    94,    95,    61,   116,   103
  };

  const signed char
  parser::yycheck_[] =
  {
      12,    20,    34,     6,     6,    17,    18,    36,    11,    34,
      39,     3,     0,    12,    23,    24,    58,    11,    21,    22,
      11,    34,    25,    32,    36,    28,    29,    26,    27,    20,
      20,    34,    35,    35,    26,    27,    48,    49,    57,    51,
      52,    53,    54,    55,    56,    34,    31,    76,    77,    91,
      92,    93,    94,    95,    33,    67,    68,    69,    70,    71,
      72,    12,     6,    75,     6,     5,    78,    11,    11,    11,
       6,     7,     8,     9,    10,    31,     6,     7,     8,     9,
      10,    25,    12,    25,     4,    29,    20,    29,    12,    30,
      34,    35,    34,    35,    26,    31,   108,     6,     7,     8,
       9,    10,     6,    12,     2,    14,    15,    16,    17,    18,
      19,     6,     7,     8,     9,    10,     8,     9,    10,    14,
  ...
  parser::yystos_[] =
  {
       0,    23,    24,    32,    39,    40,    41,    42,    44,    45,
      34,    48,    48,    34,     0,    40,    11,     6,    11,    25,
      29,    34,    35,    46,    47,    50,    53,    59,    60,    61,
      20,    34,    49,    34,    50,    50,    11,    21,    22,    28,
      50,    54,    55,    56,    57,    58,    34,    60,    11,    20,
      31,    33,     6,     7,     8,     9,    10,     5,     6,    35,
      43,    49,    12,    12,    50,    56,    56,    14,    15,    16,
      17,    18,    19,    31,     4,     3,    26,    27,    30,    50,
      51,    52,    50,    50,    50,    50,    50,    50,    50,    60,
      43,     6,     7,     8,     9,    10,    12,    50,    50,    50,
      50,    50,    50,    54,    50,    56,    56,    50,     5,    12,
      43,    43,    43,    43,    43,    31,    52
  };
  ...
  "\"global\"", "\"return\"", "\"id\"", "\"number\"", "UMINUS", "NEGATE",
  "$accept", "startsymb", "deflist", "def", "globalvar", "cExpr", "extdef",
  "funcdef", "body", "assignments", "prototype", "params", "expr",
  ...
  parser::yyrline_[] =
  {
       0,   104,   104,   107,   108,   111,   112,   113,   116,   117,
     120,   121,   122,   123,   124,   125,   126,   129,   132,   135,
     136,   140,   141,   144,   147,   148,   159,   160,   161,   162,
     163,   164,   165,   166,   167,   168,   169,   170,   173,   174,
     177,   178,   181,   184,   185,   188,   191,   192,   193,   194,
